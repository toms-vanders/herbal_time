...
public interface WorkTypeDBIF {
    List<WorkType> findAll(boolean fullAssociation) throws DataAccessException;
    List<WorkType> findAllWorkTypesOfWorkSite(Integer workSiteID, boolean fullAssociation) throws DataAccessException;
    ...
    Integer updateWorkType(int workTypeID, WorkType newWorkType) throws DataAccessException;
